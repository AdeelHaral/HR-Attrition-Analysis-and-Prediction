...
> Dataset is included in this repository as `HR\_Attrition\_Dataset.csv`.
...
!\[Correlation Heatmap](Feature\_engineering/Correlations.png)



\### 2️⃣ Countplots

!\[Countplots](Feature\_engineering/Countplots\_explorations.png)



\### 3️⃣ Distribution Plots

!\[Distribution Plots](Feature\_engineering/Distribution\_plots.png)
...
&nbsp; !\[KDE 1](Feature\_engineering/KDE\_exploration\_1.png)  

\- YearswithCurrentManager Feature in Employees who left and stayed   

&nbsp; !\[KDE 2](Feature\_engineering/KDE\_plot\_2.png)  

\- TotalworkingYear Feature in Employees who left and stayed  

&nbsp; !\[KDE 3](Feature\_engineering/kde\_plot\_3.png)



\### 5️⃣ Age vs Attrition

!\[Age vs Attrition](Feature\_engineering/age\_vs\_attrition\_Countplots.png)
...
&nbsp; !\[Final Box Plot](Feature\_engineering/final\_box\_plot.png)
...
!\[Logistic Regression Confusion Matrix](Confusion%20Matrices/Logistics\_Regression.png)



\#### Random Forest

!\[Random Forest Confusion Matrix](Confusion%20Matrices/Random\_forest.png)



\#### Artificial Neural Network (ANN)

!\[ANN Confusion Matrix](Confusion%20Matrices/ANN\_Tensorflow.png)
